    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          ...
          <div class="d-flex align-items-center">
            <a href="{{ url('/page/halamanMakanan') }}" class="btn btn-primary rounded-1">Lihat Semua Menu</a>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          ...
          <div class="d-flex align-items-center">
            <a href="{{ url('/page/halamanMakanan') }}" class="btn btn-primary me-2">Lihat Semua Mitra</a>
            <!-- <div class="swiper-buttons">
