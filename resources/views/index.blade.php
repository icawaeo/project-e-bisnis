    ...
    <div class="order-md-last">
      ...
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between lh-sm">
          <div>
            <h6 class="my-0">Paket Nasi Ayam Geprek</h6>
            <small class="text-body-secondary">1x</small>
          </div>
    ...
    <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
      ...
      <li class="nav-item border-dashed">
        <a href="index.html" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
          ...
          <span>Makanan Ringan/Camilan</span>
        </a>
      </li>
      <li class="nav-item border-dashed">
        <a href="index.html" class="nav-link d-flex align-items-center gap-3 text-dark p-2">
...
<header>
  <div class="container-fluid">
    <div class="row py-3 border-bottom align-items-center gx-3">

      <div class="col-auto d-flex align-items-center">
        <a href="index.html">
          <img src="{{ asset('images/logo-ekanteen.png') }}" alt="logo" class="img-fluid" style="max-width: 100px; height: auto;">
        </a>
      </div>

      <div class="col">
        <form id="search-form" action="index.html" method="post" class="d-flex bg-light rounded-4 p-2 align-items-center">
          <input
            type="text"
          ...
          <button type="submit" class="btn btn-link p-0 ms-2" style="color: inherit;">
      ...
      <div class="col-auto">
        <ul class="navbar-nav list-unstyled d-flex flex-row gap-4 mb-0 fw-bold text-uppercase text-dark">
          <li class="nav-item">
            <a href="index.html" class="nav-link">Semua Menu</a>
          </li>
          <li class="nav-item">
            <a href="index.html" class="nav-link">Daftar Mitra</a>
          </li>
          <li class="nav-item">
            <a href="index.html" class="nav-link">Pesanan Saya</a>
          </li>
        </ul>
      </div>
  ...
  <div class="container-lg">
    <div class="row">
      <div class="col-lg-6 pt-5 mt-5">
        ...
        <div class="row my-5">
          <div class="col">
            <div class="row text-dark flex-column align-items">
              <div class="col-auto">
                <p class="fs-1 fw-bold lh-sm mb-0">50+</p>
              </div>
              <div class="col">
                <p class="text-uppercase lh-sm mb-0 ">Menu Bervariasi</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="row text-dark flex-column align-items">
              ...
              <div class="col">
                <p class="text-uppercase lh-sm mb-0 ">Mahasiswa Terlayani</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="row text-dark flex-column align-items">
              <div class="col-auto">
                <p class="fs-1 fw-bold lh-sm mb-0">30+</p>
              </div>
              <div class="col">
                <p class="text-uppercase lh-sm mb-0">Mitra Kantin Aktif</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="card-body p-0">
                <h5 class="text-light">Bahan Segar Setiap Hari</h5>
                <p class="card-text">Langsung dari dapur mitra kantin, terjamin kebersihan & kesegarannya.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col d-flex">
        <div class="card border-0 bg-secondary rounded-0 p-4 text-light flex-fill">
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="card-body p-0">
                <h5 class="text-light">Harga Ramah Mahasiswa</h5>
                <p class="card-text">Nikmati menu lezat tanpa bikin dompet menjerit!</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col d-flex">
        <div class="card border-0 bg-danger rounded-0 p-4 text-light flex-fill">
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="card-body p-0">
                <h5 class="text-light">Tanpa Antrian</h5>
                <p class="card-text">Makananmu siap tanpa harus berdiri lama di barisan.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="category-carousel swiper">
          <div class="swiper-wrapper">
            <a href="category.html" class="nav-link swiper-slide text-center">
              <img src="https://dcostseafood.id/wp-content/uploads/2021/12/Nasi-Goreng-Tom-Yum.jpg" class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Makanan Berat</h4>
            </a>
            <a href="category.html" class="nav-link swiper-slide text-center">
              <img src="https://images.tokopedia.net/img/cache/500-square/VqbcmM/2022/4/26/cafd8783-5229-4f66-a6b0-fad4847a3c8c.jpg" class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Makanan Ringan/Camilan</h4>
            </a>
            <a href="category.html" class="nav-link swiper-slide text-center">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Mi_ayam_jamur.JPG/1200px-Mi_ayam_jamur.JPG" class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Mie/Pasta</h4>
            </a>
            <a href="category.html" class="nav-link swiper-slide text-center">
              <img src="https://static.promediateknologi.id/crop/0x0:0x0/750x500/webp/photo/p2/222/2024/08/02/IMG-20240802-WA0149-1433127918.jpg" class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Minuman</h4>
            </a>
            <a href="category.html" class="nav-link swiper-slide text-center">
              <img src="https://wiratech.co.id/wp-content/uploads/2018/05/cara-membuat-es-kepal-milo.jpg" class="rounded-circle" alt="Category Thumbnail">
              <h4 class="fs-6 mt-3 fw-normal category-title">Dessert</h4>
            </a>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          ...
          <div class="d-flex align-items-center">
            <a href="#" class="btn btn-primary rounded-1">Lihat Semua Menu</a>
          </div>
        </div>
        ...
        <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
            ...
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://i.gojekapi.com/darkroom/gofood-indonesia/v2/images/uploads/cb13f370-6ba2-4d31-b04b-7dd204dfb936_2938fb7d-7df5-4eae-bdd0-7880d058da62_Go-Biz_20200427_150745.jpeg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Paket Nasi Ayam Geprek</h3>
                <div>
                  <!-- <span class="rating">
                  ...
                  <span>(315 terjual)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp15.000</span>
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://dcostseafood.id/wp-content/uploads/2023/04/Nasi-Goreng-Spesial.jpg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Nasi Goreng Spesial</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp17.000</span>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2 justify-content-center">
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://i.gojekapi.com/darkroom/gofood-indonesia/v2/images/uploads/c5901fb3-fab2-4bb7-aabf-00f8def6ec09_Go-Biz_20210330_173839.jpeg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Mie Cakalang</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://aliansizerowaste.id/wp-content/uploads/2024/03/CS-ES-TEH_NUR-CHAMIM-3-3813748552.webp" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Es Teh Jumbo</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(230 terjual)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp7.000</span>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2 justify-content-center">
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://www.aspirasionline.com/wp-content/uploads/2018/06/1529756652734.jpg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Es Kepal Milo</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp13.000</span>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2 justify-content-center">
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://i.gojekapi.com/darkroom/gofood-indonesia/v2/images/uploads/329b9321-4ad4-479f-8e6c-441c69411d11_Go-Biz_20201102_165410.jpeg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Mie Bakso Urat</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(147 terjual)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp25.000</span>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2 justify-content-center">
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://www.pinhome.id/info-area/wp-content/uploads/2022/04/Nasi-Kuning-Timor.jpg" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Nasi Kuning</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <span class="text-dark fw-semibold">Rp12.000</span>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2 justify-content-center">
          ...
          <div class="col">
            <div class="product-item">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvU47M6-6jsQXaVmFEYglk0-V0NVc3Uz4B_A&s" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Rice Bowl Katsu</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
...
<section id="mitra-terfavorit" class="products-carousel">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-4">
          ...
          <h2 class="section-title">Mitra Terfavorit</h2>

          <div class="d-flex align-items-center">
            <a href="#" class="btn btn-primary me-2">Lihat Semua Mitra</a>
            <!-- <div class="swiper-buttons">
        ...
        <div class="swiper">
          <div class="swiper-wrapper">
            ...
            <div class="product-item swiper-slide">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://lh3.googleusercontent.com/gps-cs-s/AC9h4nq4X0hloclRlZ39K2bzxKpphBH-inxMLqwZoAeVgIiJ-MzLmpC2EYUNSstb9F2XdMrC_ihWLaw7dDwLysl7nWb1faTlMuqhtu5TmOfB6hZ6FTq4jm2jfKDWoQAbi317kafHLIl3ZQ=w408-h510-k-no" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">New Bunga Bakung Cafe</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(222 kali dipesan)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <div class="d-flex justify-content-center align-items-center gap-2">
                    <span class="text-muted small">FR6F+2JW, Jl. Ahmad Yani, Bahu, Kec. Malalayang, Kota Manado, Sulawesi Utara</span>
                  </div>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
                  <div class="row g-1 mt-2">
                    ...
                    <div class="col-12">
                      <div class="d-flex justify-content-center">
                        <a href="#" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart">Lihat Menu</a>
                      </div>
                    </div>
                    <!-- <div class="col-2"><a href="#" class="btn btn-outline-dark rounded-1 p-2 fs-6"><svg width="18" height="18"><use xlink:href="#heart"></use></svg></a></div> -->
                  </div>
            ...
            <div class="product-item swiper-slide">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://lh3.googleusercontent.com/p/AF1QipPk1kXcvFZVpWPhZdp6RRn3-fhqUJTFdW7v0YSv=w408-h544-k-no" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">RM Ayam Kuning Lalapan Jogja</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(156 kali dipesan)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <div class="d-flex justify-content-center align-items-center gap-2">
                    <span class="text-muted small">Jl. Wolter Monginsidi Lingkungan 2 No.90, Bahu, Kec. Malalayang, Kota Manado, Sulawesi Utara 95115</span>
                  </div>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
            ...
            <div class="product-item swiper-slide">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://lh3.googleusercontent.com/gps-cs-s/AC9h4npUr5HnTy2Zkrupp2ooAJuPxwInvhIXBuI7qfxirRriOPlp4HGWFyze9NHp9Vz3TY_7aeH2Y2O0kl0jrbmFFG9Riamv_rw6e6mW9odlMzAmM_AJNjC5p4-8vSLwP7zn_SQA1VxJ=w408-h544-k-no" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Ayam Geprek Sambal Mama</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(358 kali dipesan)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <div class="d-flex justify-content-center align-items-center gap-2">
                    <span class="text-muted small">FR5F+2PP, Bahu, Kec. Malalayang, Kota Manado, Sulawesi Utara</span>
                  </div>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
            ...
            <div class="product-item swiper-slide">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIFxfzonXedslW6O7yJl1_tcge502Vp7-eVA&s" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Ice Cream Molovein</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(146 kali dipesan)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <div class="d-flex justify-content-center align-items-center gap-2">
                    <span class="text-muted small">Jl. Kampus, Bahu, Kec. Malalayang, Kota Manado, Sulawesi Utara</span>
                  </div>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
            ...
            <div class="product-item swiper-slide">
              <figure>
                <a href="index.html" title="Product Title">
                  <img src="https://streetviewpixels-pa.googleapis.com/v1/thumbnail?panoid=EqM67DAtGJdC52t4rGutSg&cb_client=search.gws-prod.gps&w=408&h=240&yaw=342.22397&pitch=0&thumbfov=100" alt="Product Thumbnail" class="tab-image">
                </a>
              </figure>
              <div class="d-flex flex-column text-center">
                <h3 class="fs-6 fw-normal">Warung Nabila Kampus UNSRAT</h3>
                <div>
                  <!-- <span class="rating">
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                        <svg width="18" height="18" class="text-warning"><use xlink:href="#star-full"></use></svg>
                  ...
                  <span>(201 kali dipesan)</span>
                </div>
                <div class="d-flex justify-content-center align-items-center gap-2">
                  <!-- <del>$24.00</del> -->
                  <div class="d-flex justify-content-center align-items-center gap-2">
                    <span class="text-muted small">FR6H+RGV, Bahu, Kec, Kota Manado, Sulawesi Utara</span>
                  </div>
                  <!-- <span class="badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary">10% OFF</span> -->
                </div>
                <div class="button-area p-3 pt-0">
    ...
    <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-5">
      ...
      <div class="col">
        <div class="card mb-3 border border-dark-subtle p-3">
          ...
          <div class="card-body p-0">
            <h5>Pesan Online</h5>
            <p class="card-text">Lakukan pemesanan makanan kapan saja tanpa perlu antre.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card mb-3 border border-dark-subtle p-3">
          ...
          <div class="card-body p-0">
            ...
            <p class="card-text">Transaksi aman dengan metode digital yang terpercaya.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card mb-3 border border-dark-subtle p-3">
          ...
          <div class="card-body p-0">
            <h5>Kantin Terpilih</h5>
            <p class="card-text">Bekerja sama dengan mitra kantin di lingkungan kampus.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card mb-3 border border-dark-subtle p-3">
          ...
          <div class="card-body p-0">
            <h5>Hemat Waktu</h5>
            <p class="card-text">Pesan dulu, ambil nanti. Tanpa buang waktu di antrean.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="card mb-3 border border-dark-subtle p-3">
          ...
          <div class="card-body p-0">
            <h5>Promo Kampus</h5>
            <p class="card-text">Nikmati penawaran khusus dari mitra kuliner kampus.</p>
          </div>
        </div>
      </div>
...
<footer class="py-5">
  <div class="container-lg">
    <div class="row justify-content-center">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
        <div class="footer-menu">
          <h5 class="widget-title">Butuh Bantuan?</h5>
          <p class="mb-0">Punya pertanyaan, masukan, atau butuh bantuan?</p>
          <p class="mb-0">Hubungi kami di:</p>
          <p class="mb-0"">
                📧 <a href=" mailto:ekanteen@unsrat.ac.id" class="text-dark text-decoration-none">ekanteen@unsrat.ac.id</a><br>
            ☎️ <a href="tel:08123456789" class="text-dark text-decoration-none">0812-3456-789</a>
          </p>
        </div>
      </div>
  ...
  <div class="container-lg">
    <div class="row">
      <div class="col-12 text-center">
        <p>© 2025 eKanteen. All rights reserved.</p>
      </div>
      <!-- Jika kamu mau tambahkan credit-link juga bisa taruh di bawah sini -->
      <!-- <div class="col-12 text-center">
...
<button id="scrollToTopBtn" type="button" class="btn btn-primary btn-lg"
  style="display:none; position:fixed; bottom:40px; right:40px; z-index:1050;" aria-label="Scroll to top">
